...
```shell
npm config set {scope}:registry https://riahub.example.com/api/packages/{owner}/npm/
npm config set -- '//riahub.example.com/api/packages/{owner}/npm/:_authToken' "{token}"
```
...
```shell
npm config set @test:registry https://riahub.example.com/api/packages/testuser/npm/
npm config set -- '//riahub.example.com/api/packages/testuser/npm/:_authToken' "personal_access_token"
```

or without scope:

```shell
npm config set registry https://riahub.example.com/api/packages/testuser/npm/
npm config set -- '//riahub.example.com/api/packages/testuser/npm/:_authToken' "personal_access_token"
```
